        ...
        <div className="page-content">
          <section className="catalog">
            ...
            <div className="catalog__films-list">
              ...
              <Film src="img/pulp-fiction.jpg" alt="Pulp Fiction" name="Pulp Fiction"/>

              <Film src="img/no-country-for-old-men.jpg" alt="No Country for Old Men" name="No Country for Old Men"/>

              <Film src="img/snatch.jpg" alt="Snatch" name="Snatch"/>

              <Film src="img/moonrise-kingdom.jpg" alt="Moonrise Kingdom" name="Moonrise Kingdom"/>

              <Film src="img/seven-years-in-tibet.jpg" alt="Seven Years in Tibet" name="Seven Years in Tibet"/>

              <Film src="img/midnight-special.jpg" alt="Midnight Special" name="Midnight Special"/>

              <Film src="img/war-of-the-worlds.jpg" alt="War of the Worlds" name="War of the Worlds"/>

              <Film src="img/dardjeeling-limited.jpg" alt="Dardjeeling Limited" name="Dardjeeling Limited"/>

              <Film src="img/orlando.jpg" alt="Orlando" name="Orlando"/>

              <Film src="img/mindhunter.jpg" alt="Mindhunter" name="Mindhunter"/>
